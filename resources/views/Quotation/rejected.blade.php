        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="inline-flex">
                    ...
                    <button class="bg-gray-300 hover:bg-gray-500 text-gray-800 font-bold py-2 px-4 rounded-l" onclick="location.href='{{ url('/approved') }}'">
                        Approved
                    </button>
                    <button class="bg-blue-300 hover:bg-gray-500 text-gray-800 font-bold py-2 px-4 rounded-l" onclick="location.href='{{ url('/rejected') }}'">
                        Rejected
                    </button>
                </div> 
                        ...
                        <table class="table w-full">
                            ...
                            <tbody>
                                ...
                                @if ($service_requests !=null)
                                    ...
                                    @if ($service_request->customer_approval == 'no')
                                    <tr>
                                        <th>{{ $no++ }}</th> 
